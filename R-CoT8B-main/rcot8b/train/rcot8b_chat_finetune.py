...
import transformers
from rcot8b.dist_utils import init_dist
from rcot8b.model.internlm2.modeling_internlm2 import InternLM2ForCausalLM
from rcot8b.model.internvl_chat import (InternVisionConfig,
                                          InternVisionModel,
                                          InternVLChatConfig,
                                          RCoTChatModel8B)
from rcot8b.patch import (concat_pad_data_collator,
                            replace_llama_rmsnorm_with_fused_rmsnorm,
                            replace_train_sampler)
from rcot8b.train.constants import (BOX_END_TOKEN, BOX_START_TOKEN,
                                      IMG_CONTEXT_TOKEN, IMG_END_TOKEN,
                                      IMG_START_TOKEN, QUAD_END_TOKEN,
                                      QUAD_START_TOKEN, REF_END_TOKEN,
                                      REF_START_TOKEN)
from rcot8b.train.dataset import (ConcatDataset, TCSLoader,
                                    WeightedConcatDataset, build_transform,
                                    dynamic_preprocess, preprocess,
                                    preprocess_internlm, preprocess_mpt,
                                    preprocess_phi3)
from rcot8b.train.trainer_monkey_patch import replace_create_optimizer
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        logger.info('Loading RCoTChatModel8B...')
        ...
        model = RCoTChatModel8B.from_pretrained(
        ...
        logger.info('Building RCoTChatModel8B...')
        model = RCoTChatModel8B(internvl_chat_config, vision_model, llm)
