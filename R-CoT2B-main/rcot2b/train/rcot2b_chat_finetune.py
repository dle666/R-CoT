...
import transformers
from rcot2b.dist_utils import init_dist
from rcot2b.model.internlm2.modeling_internlm2 import InternLM2ForCausalLM
from rcot2b.model.internvl_chat import (InternVisionConfig,
                                          InternVisionModel,
                                          InternVLChatConfig,
                                          RCoTChatModel2B)
from rcot2b.patch import (concat_pad_data_collator,
                            replace_llama_rmsnorm_with_fused_rmsnorm,
                            replace_train_sampler)
from rcot2b.train.constants import (BOX_END_TOKEN, BOX_START_TOKEN,
                                      IMG_CONTEXT_TOKEN, IMG_END_TOKEN,
                                      IMG_START_TOKEN, QUAD_END_TOKEN,
                                      QUAD_START_TOKEN, REF_END_TOKEN,
                                      REF_START_TOKEN)
from rcot2b.train.dataset import (ConcatDataset, TCSLoader,
                                    WeightedConcatDataset, build_transform,
                                    dynamic_preprocess, dynamic_preprocess2, preprocess,
                                    preprocess_internlm, preprocess_mpt,
                                    preprocess_phi3)
from rcot2b.train.trainer_monkey_patch import replace_create_optimizer
...
def main():
    ...
    if model_args.model_name_or_path is not None:
        ...
        model = RCoTChatModel2B.from_pretrained(
